...
def get_excel_preference_file_data(file_name):
    ...
    for i in range(len(in_data)):
        ...
        config = {
            ...
            'TARGET_TABLE_RECREATE': int(
                src.utils.get_default_value(obj.get('TARGET_TABLE_RECREATE', ''), '0' if target_table_exists else '1')),
            ...
            'MIN_CALL_DURATION_MINUTES': int(
                src.utils.get_default_value(obj.get('MIN_CALL_DURATION_MINUTES', ''), '0')),
            'MAX_CALL_DURATION_MINUTES': int(
                src.utils.get_default_value(obj.get('MAX_CALL_DURATION_MINUTES', ''), '0')),
