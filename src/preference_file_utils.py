...
def get_excel_preference_file_data(file_name):
	...
	for i in range(len(in_data)):
		...
		config = {
			...
			'SOURCE_DRIVER': obj.get('SOURCE_DRIVER', ''),
			'SOURCE_TRUSTED_CONNECTION': obj.get('SOURCE_TRUSTED_CONNECTION', ''),
			...
			'TARGET_DRIVER': obj.get('TARGET_DRIVER', ''),
			'TARGET_TRUSTED_CONNECTION': obj.get('TARGET_TRUSTED_CONNECTION', ''),
